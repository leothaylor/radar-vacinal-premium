/*
 * Radar Vacinal ACS — release wrapper v2.1.1 (2026-09-15)
 *
 * Preserva o motor V2.1 original em ./engine-core.js e aplica apenas dois hotfixes:
 * 1) interpreta maxMonths como último mês etário inclusivo (ex.: 14a11m até a véspera dos 15 anos);
 * 2) ativa o GA4 dedicado do Radar com parâmetros funcionais estritamente sanitizados.
 *
 * Remover este wrapper numa futura refatoração somente depois de incorporar as correções ao motor/index.
 */
(function (root, factory) {
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = factory(require('./engine-core.js'), null, null);
    return;
  }

  if (!root.RadarEngine && typeof document !== 'undefined' && document.write) {
    document.write('<script src="./js/engine-core.js"><\/script>');
  }
